...
struct clique_neighborhood_reduction_fast : public general_reduction {
    ...
    virtual clique_neighborhood_reduction_fast* clone() const final {
        return new clique_neighborhood_reduction_fast(*this);
    }
...
struct generalized_neighborhood_reduction : public general_reduction {
    ...
    virtual generalized_neighborhood_reduction* clone() const final {
        return new generalized_neighborhood_reduction(*this);
    }
...
struct reduction_ptr {
    ...
    reduction_ptr(reduction_ptr&& other) : reduction(std::move(other.reduction)) { other.reduction = nullptr; };
    ...
    general_reduction* operator->() const { return reduction; }
